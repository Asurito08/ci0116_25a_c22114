...
class Ordenador {
    ...
    int heapSize;
    void crearMonticuloMaximo(uint32_t *A, uint32_t n) const;
    void maximizarMonticulo(uint32_t *A, uint32_t n) const;
    ...
    */ 
    ...
    void ordenamientoPorInsercion(uint32_t *A, uint32_t n) const;
    ...
    constexpr const char* imprimirDatosDeTarea() const {
      return "Carné: C22114, Nombre: Wilson Chavarría Miranda, Tarea 1";
    }
};